...
function (build_glew_project target prefix)
...
build_glew_project(
    glew
    ${PROJECT_SOURCE_DIR}/3rdparty/glew/build/cmake
...
set(GLEW_DIR ${PROJECT_SOURCE_DIR}/build/glew)
find_package(GLEW CONFIG QUIET HINTS ${GLEW_DIR})
